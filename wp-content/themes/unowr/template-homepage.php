...
get_header( '' ); ?>
		...
		<div id="user-part" class="ui middle aligned first-part height grid container">
			<div class="sixteen middle aligned wide column container">
		...
		<div id="user-part" class="ui first-part height center aligned grid container" style="padding-bottom:0!important">
			<div id="intro-content" class="sixteen wide middle aligned column">
		...
		<div class="ui center aligned grid" style="padding: 0 !important">
